...
void setup() {
  ...
  sx1272.setNodeAddress(2);//Set node address to 2
...
void loop() {
  ...
  if( e == 0 ){
      ...
      for (unsigned int i = 0; i < (packet_length)-3 ; i++)//Used to read payload data (returned as char array) and put it into a String
      {
